...
import figura1ss from '../../assets/result.svg';
import figura2ss from '../../assets/result2.svg';
  ...
  return (
    <div className="pss-body" id="CTA">
      ...
      <div className="pss-content">
        ...
        <TransformWrapper>
          <TransformComponent>
          <img src={figura1ss} alt="sistema nortesul"></img>
          </TransformComponent>
        </TransformWrapper>
        <TransformWrapper>
          <TransformComponent>
          <img src={figura2ss} alt="sistema nortesul"></img>
          </TransformComponent>
        </TransformWrapper>
        </div>
    </div>
