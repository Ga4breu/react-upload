  ...
  return (
    <div>
      <div className='brand-content' id="Brand">
        <h2 className='titulo'>O CARREGAMENTO MÁXIMO</h2>
        <div className='para-img'>
          ...
          <div className='table-text'>
            <h3 className='titulo-tabela'>As condições de geração e consumo do sistema após a elevação da carga em 10%:</h3>
            <img src={tabela} alt="sistema nortesul"></img>
            <h4 className='bottom-table-text'>Em relação ao caso base diminuiu-se a quantidade de perdas de MVar representando uma diminuição da geração de reativos da linha, portanto o sistema respondeu com um aumento na geração de potência reativa para suprir as cargas e o consumo de reativos das linhas.</h4>
          </div>
        </div>
