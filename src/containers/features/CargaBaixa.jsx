    ...
    <div className="cargaleve-body" id="features">
      ...
      <div className="cargaleve-content">
          <div className="cargalevetexto">
              ...
              O sistema comporta uma redução de até 20% de carga total sem exceder nenhum limite. Porém, a partir desse ponto de operação, nota-se que ao reduzir-se mais a potência consumida, algumas barras da região Sul (Blumenau, Curitiba, Salto Caxias, etc.) passam para um estado de sobretensões. Em virtude disso, faz-se necessária a ativação de reatores shunt chaveados já presentes no sistema. Com a ativação desses reatores é possível continuar a redução de carga do sistema em até 30%. A Figura 1 ilustra a região com sobretensão. </h4>    
